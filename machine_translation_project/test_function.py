...
# Define a model that will decode step-by-step
# instead of using teacher forcing
...
# Save the new LSTM output states
decoder_states = [state_hidden, state_cell]
# Redefine the decoder output by passing it through
# the dense layer
